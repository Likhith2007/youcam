    ...
    <div className="mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {ingredients.map((ing, idx) => (
          <div key={idx} className="glass-card rounded-2xl p-4 border border-slate-800 flex items-center space-x-3">
            <div className="p-3 rounded-xl bg-teal-500/10 text-teal-400 border border-teal-500/20 flex-shrink-0">
              <Sparkles className="w-5 h-5" />
            </div>
            <div>
              <h4 className="font-bold text-xs text-white">{ing.name}</h4>
